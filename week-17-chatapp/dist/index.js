    ...
    socket.on("message", (message) => {
        ...
        if (parsedMessage.type === "join") {
            ...
            allSockets.forEach((user) => {
                if (user.room === roomId && user.socket.readyState === ws_1.WebSocket.OPEN) {
        ...
        if (parsedMessage.type === "chat") {
            ...
            let currentUserRoom = (_a = allSockets.find(user => user.socket === socket)) === null || _a === void 0 ? void 0 : _a.room;
            if (!currentUserRoom)
                return;
